...
export default function RegisterMain() {
    const { register } = useAuth(); // 假设您的auth context中有register方法
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                // 验证错误
                setServerError(result.detail?.[0]?.msg || "Validation failed");
            } else {
        ...
        <Box sx={{ minHeight: "100svh", display: "grid", placeItems: "center", p: { xs: 2, sm: 3 }, bgcolor: "#ffffff" }}>
            <Card elevation={0} sx={{ width: { xs: "100%", sm: 520 }, height: { xs: "100%", sm: "auto" }, borderRadius: "16px", bgcolor: "#eef3f8", boxShadow: "0 12px 30px rgba(2,6,23,0.08)" }}>
                <CardContent sx={{ p: { xs: 3, sm: 5 } }}>
                    <Typography variant="h4" align="center" sx={{ fontWeight: 800, mb: 1 }}>Create an account</Typography>
                    ...
                    <Box component="form" noValidate onSubmit={handleSubmit}>
                        <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 1, color: "#111827" }}>Email</Typography>
                        <TextField
                        ...
                        <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 1, mt: 3, color: "#111827" }}>Password</Typography>
                        <TextField
                        ...
                        <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 1, mt: 3, color: "#111827" }}>Confirm Password</Typography>
                        <TextField
                        ...
                        <Button
                            ...
                            sx={{
                                ...
                                bgcolor: "#0f172a", "&:hover": { bgcolor: "#0b1220" }, mt: 4
                            }}
                        >
                            {submitting ? (
                                <>
