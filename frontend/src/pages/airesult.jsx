...
const ALL_ROWS = [
    ...
    { studentID: 4, markBy: "Tutor 4", tutorMark: 82, aiMark: 76, difference: -6, feedback: "", assignment: "Assignment 1" },
    { studentID: 5, markBy: "Tutor 4", tutorMark: 82, aiMark: 76, difference: -6, feedback: "", assignment: "Assignment 1" },
    { studentID: 6, markBy: "Tutor 4", tutorMark: 82, aiMark: 76, difference: -6, feedback: "", assignment: "Assignment 1" },
    { studentID: 7, markBy: "Tutor 4", tutorMark: 82, aiMark: 76, difference: -6, feedback: "", assignment: "Assignment 1" },
    { studentID: 8, markBy: "Tutor 4", tutorMark: 82, aiMark: 76, difference: -6, feedback: "", assignment: "Assignment 1" },
    { studentID: 9, markBy: "Tutor 3", tutorMark: 85, aiMark: 85, difference: 0, feedback: "", assignment: "Assignment 3" },
    { studentID: 10, markBy: "Tutor 3", tutorMark: 85, aiMark: 88, difference: 3, feedback: "", assignment: "Assignment 3" },
];
            ...
            <Box sx={{ display: "flex", flexGrow: 1 }}>
                ...
                <Box
                    ...
                    sx={{
                        ...
                        width: { xs: "100%", md: `calc(100% - ${SIDEBAR_WIDTH}px)`, lg: `calc(100% - ${SIDEBAR_WIDTH}px)` },
